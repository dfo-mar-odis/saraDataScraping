...
-------------                    | -------------       
Destignatable Unit (DU)          | Not included         
Taxon	                           | Not included      
...
#### Scenario 4: Staff takes advantage of a new workflow to store and mine the data from somewhere else 

Mining PDF and Word files is a possibility. However, is there a better approach for mining data and storing it in an authoritative place. Data could then be mined from something different than a PDF/Word file... something such as database, excel sheets, which could be populated as part of a submission. 
