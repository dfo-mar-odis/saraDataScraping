...
- Project board: AWe created a board to create, coordinate, and track milestones to be completed throughout the duration of this project: https://github.com/orgs/dfo-mar-odis/projects/2/views/14  Most of the work of this project will be coordinated asynchronously through this board (which will be linked to the code to be developed), in addition to monthly meetings. The link above is for a for a view specifically for this project, however, the board contains other views for additional projects of the Reproducible Analytical Pipeline initiative. 
- SARP documents: This project will select and review a list of SARP documents to extract data from, and identify the type of information to be standardized and extracted. The following link contains a folder that lists potential documents to be reviewed: https://086gc.sharepoint.com/sites/SciencePlanningAdviceandDataSPAD-ODIS-Logistics/Shared%20Documents/Forms/AllItems.aspx?id=%2Fsites%2FSciencePlanningAdviceandDataSPAD%2DODIS%2DLogistics%2FShared%20Documents%2FODIS%20%2D%20Logistics%2FSARA%2DMAR%2DNHQ%2DProject%2FDocuments%2DTesting&p=true&ga=1

Full description of this project is available in a protected SharePoint file: [full project text](https://086gc.sharepoint.com/:w:/s/SciencePlanningAdviceandDataSPAD-ODIS-Logistics/Ea4-6Xj0thRHopICpjdTGzUB2azLcmqBpYHKOv6GGOqxBA?e=WqMEjm)
